...
| PR-2026-09-03-05 | 2026-09-05 | CLAIM | REGISTERED | [`../EXPERT_ECONOMY.md`](../EXPERT_ECONOMY.md) | Bounded-M_max=K recruit-by-eviction economy achieves ACC and FGT within ±0.02 of unbounded M on the shipped E1 stream (≥10 fresh seeds 3–12, 95% CIs); eviction count reported; falsified if either delta exceeds 0.02. |
| PR-2026-09-03-06 | 2026-09-05 | CLAIM | NEGATIVE | [`2026-09-03-interleaved-router-bar6.md`](2026-09-03-interleaved-router-bar6.md) | Interleaved-router BAR-6 toy check: frozen config hot_young=1.0 + route_stat=sample_top must reach ACC ≥ 0.70 on BOTH interleaved streams (mixed-batch, round-robin) at n=5 seeds 10–14, with no E1 regression (ACC 0.834±0.02, FGT ≤ 0.02); else the fix is declared insufficient and PR-LM-1 stays blocked. **OUTCOME (2026-09-05): INSUFFICIENT** — bar 1 PASS (E1 0.842/FGT 0.000), bar 2 FAIL both streams (+fixes 0.597/0.592, CI uppers 0.646/0.643 < 0.70); attribution: route_stat carries all (+0.058 rr), hot_young ≈ 0; route ledger: one expert trains on 100% of the stream → monolithic-learner ceiling (~0.60) confirmed. Binding constraint = batch-level training granularity. PR-LM-1 BLOCKED on the router; successor mechanisms (per-sample routed delta / recruitment-session windows / replay-before-freeze) each need their own pre-registration. Artifacts: results/interleave_fix_PR-2026-09-03-06/, results/interleave_bar6_2026-09-05/. |
