...
> **Bu belgenin Türkçe orijinali.** Birincil (İngilizce) sürüm: [`docs/Prizma.md`](Prizma.md).
> Bu dosya kaynak metin olarak korunmaktadır; iki sürüm ayrıldığında bu dosya esastır.
> ---
> *This is the Turkish original. The primary (English) version is [`docs/Prizma.md`](Prizma.md);
> this file is kept verbatim as the source text and takes precedence where the two diverge.*
